...
class NetworkLayoutOperationPeak(cea.plots.thermal_networks.ThermalNetworksMapPlotBase):
    ...
    def nodes_df(self):
        ...
        temperature_supply_plant = self.temperature_supply_return_plant_C['temperature_supply_K'] - KELVIN_OFFSET
        temperature_return_plant = self.temperature_supply_return_plant_C['temperature_return_K'] - KELVIN_OFFSET
