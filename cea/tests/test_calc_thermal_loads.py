...
class TestCalcThermalLoads(unittest.TestCase):
    ...
    def test_calc_thermal_loads(self):
        ...
        value_columns = [u'Ealf_kWh', u'Eauxf_kWh', u'Edataf_kWh', u'Ef_kWh', u'QCf_kWh', u'QHf_kWh',
                         ...
                         u'Twwf_sup_C']
        values = [155102.61600000001, 3817.3040000000001, 0.0, 158919.92000000001, 8373.9639999999999,
                  235413.77499999999, 0, 0, 7888.4459999999999, 8373.9639999999999, 183389.465, 195411.984,
                  37198.886999999995, 40001.764999999999, 2567.0, 67361.358999999997, 99496.0, 1812.0,
                  77058.267999999996, 525600]
