    ...
    for building_name in building_names:
        ...
        if config.decentralized.AHUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_AHU_operation['wdot_W']  # CHF
                result_AHU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_AHU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_AHU_operation['wdot_W'] * 3600E-6  # MJ-oil-eq
                ...
                result_AHU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_AHU_operation['wdot_W']  # CHF
                result_AHU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_AHU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_AHU_operation['wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if config.decentralized.ARUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_ARU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_ARU_operation['wdot_W']  # CHF
                result_ARU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_ARU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_ARU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_ARU_operation['wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
                ...
                result_ARU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_ARU_operation['wdot_W']  # CHF
                result_ARU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_ARU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_ARU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_ARU_operation['wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if config.decentralized.SCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_SCU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_SCU_operation['wdot_W']  # CHF
                result_SCU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_SCU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_SCU_operation[
                ...
                result_SCU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_SCU_operation['wdot_W']  # CHF
                result_SCU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_SCU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if config.decentralized.AHUARUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU_ARU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_AHU_ARU_operation['wdot_W']  # CHF
                result_AHU_ARU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_AHU_ARU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_ARU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_AHU_ARU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
                ...
                result_AHU_ARU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_AHU_ARU_operation['wdot_W']  # CHF
                result_AHU_ARU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_AHU_ARU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_ARU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_AHU_ARU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if config.decentralized.AHUSCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU_SCU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_AHU_SCU_operation['wdot_W']  # CHF
                result_AHU_SCU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_AHU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_SCU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_AHU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
                ...
                result_AHU_SCU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_AHU_SCU_operation['wdot_W']  # CHF
                result_AHU_SCU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_AHU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_SCU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_AHU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if config.decentralized.ARUSCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_ARU_SCU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_ARU_SCU_operation['wdot_W']  # CHF
                result_ARU_SCU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_ARU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_ARU_SCU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
                ...
                result_ARU_SCU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_ARU_SCU_operation['wdot_W']  # CHF
                result_ARU_SCU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_ARU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_ARU_SCU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
        ...
        if True: # for the case with AHU + ARU + SCU scenario. this should always be present
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU_ARU_SCU[2][7] += lca.ELEC_PRICE * single_effect_ACH_to_AHU_ARU_SCU_operation['wdot_W']  # CHF
                result_AHU_ARU_SCU[2][8] += lca.EL_TO_CO2 * single_effect_ACH_to_AHU_ARU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_ARU_SCU[2][9] += lca.EL_TO_OIL_EQ * single_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                # calculate load for CT and boilers
                ...
                result_AHU_ARU_SCU[3][7] += lca.ELEC_PRICE * double_effect_ACH_to_AHU_ARU_SCU_operation['wdot_W']  # CHF
                result_AHU_ARU_SCU[3][8] += lca.EL_TO_CO2 * double_effect_ACH_to_AHU_ARU_SCU_operation['wdot_W'] * 3600E-6  # kgCO2
                result_AHU_ARU_SCU[3][9] += lca.EL_TO_OIL_EQ * double_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # MJ-oil-eq
                ...
                result_AHU_ARU_SCU[4][7] += lca.ELEC_PRICE * (VCC_to_AHU_ARU_operation['wdot_W'] + VCC_to_SCU_operation['wdot_W'])  # CHF
                result_AHU_ARU_SCU[4][8] += lca.EL_TO_CO2 * (VCC_to_AHU_ARU_operation['wdot_W'] + VCC_to_SCU_operation['wdot_W']) * 3600E-6  # kgCO2
                result_AHU_ARU_SCU[4][9] += lca.EL_TO_OIL_EQ * (VCC_to_AHU_ARU_operation['wdot_W'] + VCC_to_SCU_operation['wdot_W']) * 3600E-6  # MJ-oil-eq
                ...
                single_effect_ACH_to_SCU_operation = chiller_absorption.calc_chiller_main(mdot_SCU_kgpers[hour],
                                                                                          ...
                                                                                          Qnom_ACH_SCU_W,
                                                                                          locator, config)
                result_AHU_ARU_SCU[5][7] += lca.ELEC_PRICE * (VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W'])  # CHF
                result_AHU_ARU_SCU[5][8] += lca.EL_TO_CO2 * (VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W']) * 3600E-6  # kgCO2
                result_AHU_ARU_SCU[5][9] += lca.EL_TO_OIL_EQ * (VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W']) * 3600E-6  # MJ-oil-eq
