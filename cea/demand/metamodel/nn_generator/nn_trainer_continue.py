...
def run_nn_continue(locator, random_variables, target_parameters, list_building_names, weather_path, gv):
    '''
...
def run_as_script():
    ...
    run_nn_continue(locator, random_variables, target_parameters, list_building_names, weather_path, gv)
