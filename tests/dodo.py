...
REFERENCE_CASES = {
    'open': os.path.join(REFERENCE_CASE_PATH, "cea-reference-case-%s" % REPOSITORY_NAME, "reference-case-open",
                         "decentralized_buildings"),
    'zug/decentralized_buildings': os.path.join(REFERENCE_CASE_PATH, "cea-reference-case-%s" % REPOSITORY_NAME, "reference-case-zug",
                                 "decentralized_buildings"),
    'zurich/decentralized_buildings': os.path.join(REFERENCE_CASE_PATH, "cea-reference-case-%s" % REPOSITORY_NAME,
...
REFERENCE_CASES_DATA = {
    ...
    'zug/decentralized_buildings': {'weather': 'Zug', 'latitude': 47.1628017306431, 'longitude': 8.31,
    ...
    'zurich/decentralized_buildings': {'weather': 'Zurich', 'latitude': 46.9524055556, 'longitude': 7.43958333333,
