        ...
        try:
            ...
            if os.path.exists(temp_supply_file):
                ...
                if plant_id in temp_df.columns:
                    avg_supply_temp_C = temp_df[plant_id].mean() - KELVIN_OFFSET
                    min_supply_temp_C = temp_df[plant_id].min() - KELVIN_OFFSET
                    max_supply_temp_C = temp_df[plant_id].max() - KELVIN_OFFSET
                else:
                    avg_supply_temp_C = 0
                    min_supply_temp_C = 0
                    max_supply_temp_C = 0
            ...
            if os.path.exists(temp_return_file):
                ...
                if plant_id in temp_df.columns:
                    avg_return_temp_C = temp_df[plant_id].mean() - KELVIN_OFFSET
                else:
                    avg_return_temp_C = 0
            else:
                avg_return_temp_C = 0
