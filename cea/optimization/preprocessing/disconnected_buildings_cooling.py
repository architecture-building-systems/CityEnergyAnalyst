    ...
    for building_name in building_names:
        ...
        if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU_ARU_SCU[2][7] += prices.ELEC_PRICE * single_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W']  # CHF
                result_AHU_ARU_SCU[2][8] += EL_TO_CO2 * single_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # kgCO2
                ...
                result_AHU_ARU_SCU[3][7] += prices.ELEC_PRICE * double_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W']  # CHF
                result_AHU_ARU_SCU[3][8] += EL_TO_CO2 * double_effect_ACH_to_AHU_ARU_SCU_operation[
                    'wdot_W'] * 3600E-6  # kgCO2
                ...
                single_effect_ACH_to_SCU_operation = chiller_absorption.calc_chiller_main(mdot_SCU_kgpers[hour],
                                                                                          ...
                                                                                          Qc_nom_combination_SCU_W,
                                                                                          locator, config)
                result_AHU_ARU_SCU[5][7] += prices.ELEC_PRICE * (
                VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W'])  # CHF
                result_AHU_ARU_SCU[5][8] += EL_TO_CO2 * (
                VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W']) * 3600E-6  # kgCO2
                result_AHU_ARU_SCU[5][9] += EL_TO_OIL_EQ * (
                VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation[
                    'wdot_W']) * 3600E-6  # MJ-oil-eq
        ...
        boiler_single_ACH_to_AHU_ARU_SCU_nom_size_W = np.max(q_boiler_single_ACH_to_AHU_ARU_SCU_W) * (
        1 + Q_MARGIN_DISCONNECTED)
        burner_double_ACH_to_AHU_ARU_SCU_nom_size_W = np.max(q_burner_double_ACH_to_AHU_ARU_SCU_W) * (
        1 + Q_MARGIN_DISCONNECTED)
        ...
        for hour in range(8760):
            ...
            if config.disconnected_cooling.ARUflag:
                ...
                q_burner_double_ACH_to_ARU_W[hour] > 0 else 0
                Q_gas_for_burner_Wh = q_burner_double_ACH_to_AHU_W[hour] / burner_eff if burner_eff > 0 else 0
            ...
            if config.disconnected_cooling.SCUflag:
                ...
                burner_eff = boiler.calc_Cop_boiler(q_burner_double_ACH_to_SCU_W[hour],
                                                    burner_double_ACH_to_SCU_nom_size_W) if \
                q_burner_double_ACH_to_SCU_W[hour] > 0 else 0
                Q_gas_for_burner_Wh = q_burner_double_ACH_to_AHU_W[hour] / burner_eff if burner_eff > 0 else 0
            ...
            if config.disconnected_cooling.AHUARUflag:
                ...
                q_boiler_single_ACH_to_AHU_ARU_W[
                    hour] > 0 else 0
                ...
                burner_eff = boiler.calc_Cop_boiler(q_burner_double_ACH_to_AHU_ARU_W[hour],
                                                    burner_double_ACH_to_AHU_ARU_nom_size_W) if \
                q_burner_double_ACH_to_AHU_ARU_W[hour] > 0 else 0
                Q_gas_for_burner_Wh = q_burner_double_ACH_to_AHU_W[hour] / burner_eff if burner_eff > 0 else 0
            ...
            if config.disconnected_cooling.AHUSCUflag:
                ...
                q_boiler_single_ACH_to_AHU_SCU_W[
                    hour] > 0 else 0
                ...
                burner_eff = boiler.calc_Cop_boiler(q_burner_double_ACH_to_AHU_SCU_W[hour],
            ...
            if config.disconnected_cooling.ARUSCUflag:
                ...
                q_boiler_single_ACH_to_ARU_SCU_W[
                    hour] > 0 else 0
                ...
                burner_eff = boiler.calc_Cop_boiler(q_burner_double_ACH_to_ARU_SCU_W[hour],
                                                    burner_double_ACH_to_ARU_SCU_nom_size_W) if \
                q_burner_double_ACH_to_ARU_SCU_W[hour] > 0 else 0
                Q_gas_for_burner_Wh = q_burner_double_ACH_to_AHU_W[hour] / burner_eff if burner_eff > 0 else 0
            ...
            if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
                ...
                q_boiler_single_ACH_to_AHU_ARU_SCU_W[
                    hour] > 0 else 0
                ...
                q_burner_double_ACH_to_AHU_ARU_SCU_W[hour] > 0 else 0
                Q_gas_for_burner_Wh = q_burner_double_ACH_to_AHU_W[hour] / burner_eff if burner_eff > 0 else 0
