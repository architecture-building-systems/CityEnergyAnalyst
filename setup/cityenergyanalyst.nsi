...
!define MINICONDA "https://repo.continuum.io/miniconda/Miniconda3-latest-Windows-x86_64.exe"
...
nsExec::ExecToLog '"$INSTDIR\Scripts\conda.exe" install -c conda-forge -y geopandas ephem "pandas<0.20" scikit-learn'
