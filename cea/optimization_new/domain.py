...
def main(config: cea.config.Configuration):
    ...
    # If using an existing network layout (not autogenerated), load it FIRST to identify district-connected buildings
    ...
    if not config.optimization_new.use_auto_generated_layout:
        ...
        if hasattr(current_domain, 'base_building_to_network'):
            ...
            if not buildings_to_optimize:
                print(f"  Loading ALL buildings in scenario (network + standalone)\n")
        ...
        print("\nUsing autogenerated network layout (connectivity from Building Properties/Supply settings DISTRICT scale)")
    ...
    # If using autogenerated layout, just report connectivity from Building Properties/Supply settings
    ...
    if config.optimization_new.use_auto_generated_layout:
        ...
        if network_buildings:
            print(f"  Buildings for autogenerated networks (DISTRICT scale in Building Properties/Supply settings): {network_buildings}")
            print(f"    → Network layout will be generated using Steiner tree algorithm on street network")
