...
.. csv-table::
    ...
    ``GRID_kWh``, "Grid total electricity consumption = GRID_ve + GRID_a + GRID_l + GRID_v + GRID_data + GRID_pro + GRID_aux + GRID_cdata + GRID_cre + GRID_hs + GRID_ww + GRID_cs"
    ...
    ``QC_sys_kWh``, "Total energy demand for cooling"
    ...
    ``QH_sys_kWh``, "Total energy demand for heating"
...
.. csv-table::
    ...
    ``DC_cs_MWhyr``, "Energy consumption of space cooling system (if supplied by District Cooling)"
    ...
    ``E_cs_MWhyr``, "Energy consumption of cooling system (if supplied by electricity grid)"
