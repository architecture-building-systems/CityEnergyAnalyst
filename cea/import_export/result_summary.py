...
normalisation_name_mapping = {
    ...
    'appliances[kgCO2e]': 'appliances[kgCO2e/m2]',
    ...
    'appliances_NATURALGAS[kgCO2e]': 'appliances_NATURALGAS[kgCO2e/m2]',
    'appliances_BIOGAS[kgCO2e]': 'appliances_BIOGAS[kgCO2e/m2]',
    'appliances_SOLAR[kgCO2e]': 'appliances_SOLAR[kgCO2e/m2]',
    'appliances_DRYBIOMASS[kgCO2e]': 'appliances_DRYBIOMASS[kgCO2e/m2]',
    'appliances_WETBIOMASS[kgCO2e]': 'appliances_WETBIOMASS[kgCO2e/m2]',
    'appliances_GRID[kgCO2e]': 'appliances_GRID[kgCO2e/m2]',
    'appliances_COAL[kgCO2e]': 'appliances_COAL[kgCO2e/m2]',
    'appliances_WOOD[kgCO2e]': 'appliances_WOOD[kgCO2e/m2]',
    'appliances_OIL[kgCO2e]': 'appliances_OIL[kgCO2e/m2]',
    'appliances_HYDROGEN[kgCO2e]': 'appliances_HYDROGEN[kgCO2e/m2]',
    'appliances_NONE[kgCO2e]': 'appliances_NONE[kgCO2e/m2]',
...
def map_metrics_cea_features(list_metrics_or_features, direction="metrics_to_features"):
    ...
    mapping_dict = {
        ...
        "operational_emissions": [
            'heating[kgCO2e]', 'hot_water[kgCO2e]', 'cooling[kgCO2e]', 'appliances[kgCO2e]',
            ...
            'cooling_HYDROGEN[kgCO2e]', 'cooling_NONE[kgCO2e]', 'appliances_NATURALGAS[kgCO2e]',
            'appliances_BIOGAS[kgCO2e]',
            'appliances_SOLAR[kgCO2e]', 'appliances_DRYBIOMASS[kgCO2e]', 'appliances_WETBIOMASS[kgCO2e]',
            'appliances_GRID[kgCO2e]',
            'appliances_COAL[kgCO2e]', 'appliances_WOOD[kgCO2e]', 'appliances_OIL[kgCO2e]',
            'appliances_HYDROGEN[kgCO2e]', 'appliances_NONE[kgCO2e]'
        ],
...
def map_metrics_and_cea_columns(input_list, direction="metrics_to_columns"):
    ...
    mapping_dict = {
        ...
        'heating_NATURALGAS[kgCO2e]': ['heating_NATURALGAS_kgCO2e'],
        'heating_BIOGAS[kgCO2e]': ['heating_BIOGAS_kgCO2e'],
        'heating_SOLAR[kgCO2e]': ['heating_SOLAR_kgCO2e'],
        'heating_DRYBIOMASS[kgCO2e]': ['heating_DRYBIOMASS_kgCO2e'],
        'heating_WETBIOMASS[kgCO2e]': ['heating_WETBIOMASS_kgCO2e'],
        'heating_GRID[kgCO2e]': ['heating_GRID_kgCO2e'],
        'heating_COAL[kgCO2e]': ['heating_COAL_kgCO2e'],
        'heating_WOOD[kgCO2e]': ['heating_WOOD_kgCO2e'],
        'heating_OIL[kgCO2e]': ['heating_OIL_kgCO2e'],
        'heating_HYDROGEN[kgCO2e]': ['heating_HYDROGEN_kgCO2e'],
        'heating_NONE[kgCO2e]': ['heating_NONE_kgCO2e'],
        'hot_water_NATURALGAS[kgCO2e]': ['hot_water_NATURALGAS_kgCO2e'],
        'hot_water_BIOGAS[kgCO2e]': ['hot_water_BIOGAS_kgCO2e'],
        'hot_water_SOLAR[kgCO2e]': ['hot_water_SOLAR_kgCO2e'],
        'hot_water_DRYBIOMASS[kgCO2e]': ['hot_water_DRYBIOMASS_kgCO2e'],
        'hot_water_WETBIOMASS[kgCO2e]': ['hot_water_WETBIOMASS_kgCO2e'],
        'hot_water_GRID[kgCO2e]': ['hot_water_GRID_kgCO2e'],
        'hot_water_COAL[kgCO2e]': ['hot_water_COAL_kgCO2e'],
        'hot_water_WOOD[kgCO2e]': ['hot_water_WOOD_kgCO2e'],
        'hot_water_OIL[kgCO2e]': ['hot_water_OIL_kgCO2e'],
        'hot_water_HYDROGEN[kgCO2e]': ['hot_water_HYDROGEN_kgCO2e'],
        'hot_water_NONE[kgCO2e]': ['hot_water_NONE_kgCO2e'],
        'cooling_NATURALGAS[kgCO2e]': ['cooling_NATURALGAS_kgCO2e'],
        'cooling_BIOGAS[kgCO2e]': ['cooling_BIOGAS_kgCO2e'],
        'cooling_SOLAR[kgCO2e]': ['cooling_SOLAR_kgCO2e'],
        'cooling_DRYBIOMASS[kgCO2e]': ['cooling_DRYBIOMASS_kgCO2e'],
        'cooling_WETBIOMASS[kgCO2e]': ['cooling_WETBIOMASS_kgCO2e'],
        'cooling_GRID[kgCO2e]': ['cooling_GRID_kgCO2e'],
        'cooling_COAL[kgCO2e]': ['cooling_COAL_kgCO2e'],
        'cooling_WOOD[kgCO2e]': ['cooling_WOOD_kgCO2e'],
        'cooling_OIL[kgCO2e]': ['cooling_OIL_kgCO2e'],
        'cooling_HYDROGEN[kgCO2e]': ['cooling_HYDROGEN_kgCO2e'],
        'cooling_NONE[kgCO2e]': ['cooling_NONE_kgCO2e'],
        'appliances_NATURALGAS[kgCO2e]': ['appliances_NATURALGAS_kgCO2e'],
        'appliances_BIOGAS[kgCO2e]': ['appliances_BIOGAS_kgCO2e'],
        'appliances_SOLAR[kgCO2e]': ['appliances_SOLAR_kgCO2e'],
        'appliances_DRYBIOMASS[kgCO2e]': ['appliances_DRYBIOMASS_kgCO2e'],
        'appliances_WETBIOMASS[kgCO2e]': ['appliances_WETBIOMASS_kgCO2e'],
        'appliances_GRID[kgCO2e]': ['appliances_GRID_kgCO2e'],
        'appliances_COAL[kgCO2e]': ['appliances_COAL_kgCO2e'],
        'appliances_WOOD[kgCO2e]': ['appliances_WOOD_kgCO2e'],
        'appliances_OIL[kgCO2e]': ['appliances_OIL_kgCO2e'],
        'appliances_HYDROGEN[kgCO2e]': ['appliances_HYDROGEN_kgCO2e'],
        'appliances_NONE[kgCO2e]': ['appliances_NONE_kgCO2e'],
        ...
        'operation_appliances[kgCO2e]': ['operation_appliances_kgCO2e'],
...
list_metrics_operational_emissions = [
    ...
    'cooling_SOLAR[kgCO2e]', 'cooling_DRYBIOMASS[kgCO2e]', 'cooling_WETBIOMASS[kgCO2e]',
    'cooling_GRID[kgCO2e]', 'cooling_COAL[kgCO2e]', 'cooling_WOOD[kgCO2e]', 'cooling_OIL[kgCO2e]',
    'cooling_HYDROGEN[kgCO2e]', 'cooling_NONE[kgCO2e]', 'appliances_NATURALGAS[kgCO2e]', 'appliances_BIOGAS[kgCO2e]',
    'appliances_SOLAR[kgCO2e]', 'appliances_DRYBIOMASS[kgCO2e]', 'appliances_WETBIOMASS[kgCO2e]', 'appliances_GRID[kgCO2e]',
    'appliances_COAL[kgCO2e]', 'appliances_WOOD[kgCO2e]', 'appliances_OIL[kgCO2e]', 'appliances_HYDROGEN[kgCO2e]', 'appliances_NONE[kgCO2e]'
]
