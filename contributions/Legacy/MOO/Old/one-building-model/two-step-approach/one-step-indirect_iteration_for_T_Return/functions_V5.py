...
HOURS_IN_DAY = 24
DAYS_IN_YEAR = 365
mdot_step_counter = [0.05, 0.1, 0.15 ,0.3, 0.4, 0.5 , 0.6, 1] # scheme for massflow in DH 
...
for i in range(len(building_list_array)):
    ...
    result_arrays = translate_J_plus_to_DH_requirements(DAYS_IN_YEAR, HOURS_IN_DAY, thermal_data, hex_design_data, hex_type, temperature_data, U, cp, mdot_step_counter)
    ...
    fName_result = "1420_" + building_list_array[i,0] + "_result.csv"
