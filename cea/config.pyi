...
class DemandSection(Section):
    ...
    def __getattr__(self, item: Literal["buildings"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["loads_output"]) -> List[str]: ...
    @overload
    def __getattr__(self, item: Literal["massflows_output"]) -> List[str]: ...
    @overload
    def __getattr__(self, item: Literal["temperatures_output"]) -> List[str]: ...
    @overload
...
class NetworkLayoutSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["type_mat"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["allow_looped_networks"]) -> bool: ...
    @overload
...
class SchemasSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["args"]) -> Any: ...
    def __getattr__(self, item: str) -> Any: ...
...
class Parameter:
    ...
    def replace_references(self, encoded_value) -> None: ...
