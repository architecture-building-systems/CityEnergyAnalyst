...
from networkx.algorithms.tree import greedy_branching
...
def calc_greedy_branching_tree(input_network_shp, output_network_folder, building_nodes_shp, output_edges, output_nodes,
    ...
    mst_non_directed = nx.Graph(nx.minimum_spanning_tree(G))
