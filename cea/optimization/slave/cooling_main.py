...
def cooling_calculations_of_DC_buildings(locator, master_to_slave_vars, ntwFeat, gv, prices, lca, config, reduced_timesteps_flag):
    ...
    if Qh_req_from_CCGT_max_W > 0:
        ...
        while (Qh_output_CCGT_max_W - Qh_req_from_CCGT_max_W) <= 0:
            ...
            CCGT_performances = cogeneration.calc_cop_CCGT(Q_GT_nom_sizing_W, ACH_T_IN_FROM_CHP, GT_fuel_type, prices, lca, hour)
        ...
        CCGT_performances = cogeneration.calc_cop_CCGT(Q_GT_nom_W, ACH_T_IN_FROM_CHP, GT_fuel_type, prices, lca, hour)
