...
.. csv-table::
    ...
    ``generation``, "No. of the Generation or Iteration (Genetic Algorithm)"
...
.. csv-table::
    ...
    ``B01_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B02_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B03_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B04_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B05_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B06_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B07_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B08_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``B09_DH``, "flag to indicate whether this building is connected to DH (0: no intersection, 1: intersected)"
    ``DB_Cogen``, "Sizing ratio for Combined Heat and Power (Cogeneration) Plant with Dry Biomass, a fraction of peak district heating demand"
    ``DS_HP``, "Sizing ratio for Server-Source Heat Pump, a fraction of peak district heating demand"
    ``generation``, "No. Generation or Iteration (Genetic Algorithm)"
    ``GS_HP``, "Sizing ratio for Ground-Source Heat Pump, a fraction of peak district heating demand"
    ``individual``, "No. of Individual (Genetic Algorithm)"
    ``NG_BaseBoiler``, "Sizing ratio for Natural Gas Base Boiler, a fraction of peak district heating demand"
    ``NG_Cogen``, "Sizing ratio for Combined Heat and Power (Cogeneration) Plant with Natural Gas, a fraction of peak district heating demand"
    ``NG_PeakBoiler``, "Sizing ratio for Natural Gas Peak Boiler, a fraction of peak district heating demand"
    ``PV``, "Sizing ratio for PV, a fraction of total surface area available for installation"
    ``PVT``, "Sizing ratio for PVT, a fraction of total surface area available for installation"
    ``SC_ET``, "Sizing ratio for Solar Collectors (Evacuated Tube), a fraction of total surface area available for installation"
    ``SC_FP``, "Sizing ratio for Solar Collectors (Flate Plate), a fraction of total surface area available for installation"
    ``SS_HP``, "Sizing ratio for Sewage-Source Heat Pump, a fraction of peak district heating demand"
    ``WB_Cogen``, "Sizing ratio for Combined Heat and Power (Cogeneration) Plant with Wet Biomass, a fraction of peak district heating demand"
    ``WS_HP``, "Sizing ratio for Lake-Source Heat Pump, a fraction of peak district heating demand"
