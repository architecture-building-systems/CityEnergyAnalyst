...
import SolarPowerHandler_V4 as SPH_fn
...
T_storage_old = MS_Var.T_storage_initial
Q_in_storage_old = MS_Var.Q_in_storage_initial
T_amb = 10 + 273.0 # K
...
while HOUR < HOURS_IN_DAY*DAYS_IN_YEAR:
    ...
    Storage_Data = SPH_fn.Storage_Operator(Q_solar_available, Q_network_demand, T_storage_old, T_DH_sup, T_amb, Q_in_storage_old, T_DH_return, mdot_DH)
