...
def main(output_file):
    ...
    result = calc_thermal_loads('B1011', bpr, weather_data, date_range, locator, use_dynamic_infiltration_calculation, config, debug)
...
def run_for_single_building(building, bpr: BuildingPropertiesRow, weather_data, date_range, locator,
                            use_dynamic_infiltration_calculation, config, debug):
