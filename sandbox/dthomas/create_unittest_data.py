...
def main():
    ...
    result = calc_thermal_loads('B140577', bpr, weather_data, usage_schedules, date, gv, locator.get_temporary_folder(),
    ...
    for building in buildings.keys():
        ...
        b, qcf_kwh, qhf_kwh = run_for_single_building(building, bpr, weather_data, usage_schedules,
                                                      date, gv,
                                                      locator.get_temporary_folder(),
                                                      locator.get_temporary_file('%s.csv' % building))
...
def run_for_single_building(building, bpr, weather_data, usage_schedules, date, gv, temporary_folder, temporary_file):
    calc_thermal_loads(building, bpr, weather_data, usage_schedules, date, gv, temporary_folder, temporary_folder)
