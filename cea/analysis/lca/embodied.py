...
def lca_embodied(locator, config):
    ...
    ## excavation
    data_merged_df['volume_excavation_bg'] = data_merged_df['footprint'] * data_merged_df['height_bg']
    ...
    data_merged_df['internal_floor_area'] = (data_merged_df['footprint'] * data_merged_df['floors_ag']) + (data_merged_df['footprint'] * (1 - data_merged_df['floors_bg']))
    ## roof area:
    data_merged_df['roof_area'] = data_merged_df['footprint']
    ## fundations area:
    data_merged_df['fundation_area'] = data_merged_df['footprint']
    ## total floor area
