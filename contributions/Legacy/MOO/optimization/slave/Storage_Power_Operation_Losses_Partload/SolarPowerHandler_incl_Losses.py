...
while HOUR < HOUR_MAX:
    ...
    storage_data = Storage_Operator(Q_solar_available[HOUR], Q_network_demand[HOUR], T_storage_old, T_DH_sup, \
                        T_amb, Q_in_storage_old, mdot_DH, T_DH_return)
