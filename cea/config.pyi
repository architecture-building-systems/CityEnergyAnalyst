...
class PathwaySimulationsSection(Section):
    ...
    existing_pathway_name: str
    skip_already_simulated_states: bool
    skip_custom_states: bool

    @overload
    def __getattr__(self, item: Literal["existing_pathway_name"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["skip_already_simulated_states"]) -> bool: ...
    @overload
    def __getattr__(self, item: Literal["skip_custom_states"]) -> bool: ...
    def __getattr__(self, item: str) -> Any: ...
...
class PathwayStateEditSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["buildings_to_demolish"]) -> list[str]: ...
    @overload
...
class WorkflowSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["resume_file"]) -> str | None: ...
    @overload
...
class OptionalBuildingsParameter(Parameter): ...
class OrderedMultiChoiceParameter(Parameter): ...
class PathParameter(Parameter): ...
class PathwayConstructBuildingsParameter(Parameter): ...
class PathwayDemolishBuildingsParameter(Parameter): ...
...
class SimulatedPathwayMultiChoiceParameter(Parameter): ...
...
class SubfolderMultiChoiceParameter(Parameter): ...
...
class _PathwayEventBuildingsParameter(Parameter): ...
