...
def Storage_Design(CSV_NAME, SOLCOL_TYPE, T_storage_old_K, Q_in_storage_old_W, locator,
    ...
    # Recover Solar Data
    Solar_E_aux_W = np.ravel(Solar_E_aux_SC_req_kWh * 1000 * MS_Var.SOLAR_PART_SC) + np.ravel(
        Solar_E_aux_PVT_kW * 1000 * MS_Var.SOLAR_PART_PVT) \
    ...
    for hour in range(8760):
        ...
        E_consumed_for_storage_solar_and_heat_recovery_W[hour] = E_aux_ch_fin_W[hour] + E_aux_dech_fin_W[hour] + \
