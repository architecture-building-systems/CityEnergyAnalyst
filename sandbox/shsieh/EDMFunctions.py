...
def optimal_angle_and_tilt( observers_all, latitude, worst_sh, worst_Az, transmittivity, diffuseProp, grid_side,
                            module_lenght, angle_north, Min_Isol, Max_Isol):
...
def Calc_pv_generation( type_panel, hourly_radiation, Number_groups, number_points, prop_observers, T_G_hour, latitude, misc_losses):
    ...
    a3,\
    a4,\
    L  = calc_propertiesPV(type_panel)
...
def calc_sunrise(T_G_day,Yearsimul,timezone,longitude,latitude):
    ...
    :param longitude:
    :param latitude:
    :return: T_G_day: Time of Sunrise.
    """
    o = ephem.Observer()
    o.lat = str(latitude)
