...
def terrain_elevation_extractor(locator, config):
    ...
    assert os.path.exists(
        locator.get_surroundings_geometry()), 'Get district geometry file first or the coordinates of the area where' \
    ...
    bounding_box_district_file, crs, lon, lat = calc_bounding_box_projected_coordinates(locator.get_surroundings_geometry(), locator.get_zone_geometry())
