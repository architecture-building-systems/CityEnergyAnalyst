...
results_path = "/Users/Tim/Desktop/ETH/Masterarbeit/Tools/NewNew"
...
import numpy as np
import pandas as pd
import substation_combined_functions as fn
...
T_return_min_all_buildings = fn.find_max_temp_of_buildings(building_list, "trhs", DAYS_IN_YEAR, HOURS_IN_DAY)
...
for i in range(len(building_list_array)):
    ...
    results = pd.DataFrame({"mdot_DH_result":mdot_DH_result_flat,"T_return_DH_result":T_return_DH_result_flat,"T_supply_DH_result":T_supply_DH_result_flat, "mdot_heating_result":mdot_heating_result_flat,"mdot_dhw_result":mdot_dhw_result_flat, "mdot_cool_result":mdot_cool_result_flat, "T_r1_dhw_result":T_r1_dhw_result_flat,"T_r1_heating_result":T_r1_heating_result_flat, "T_return_DC_result":T_r1_cool_result_flat, "A_hex_heating_design":A_hex_heating_design, "A_hex_dhw_design":A_hex_dhw_design, "A_hex_cool_design":A_hex_cool_design, "Q_heating":Q_heating_array_flat, "Q_dhw":Q_dhw_array_flat, "Q_cool":Q_cool_array_flat})
