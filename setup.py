...
INSTALL_REQUIRES = ['setuptools', 'doit==0.29.0', 'ephem', 'py4design', 'requests', 'xlrd', 'utm', 'pyyaml', 'sphinx', 'twine',
                    'ipython', 'pymc3', 'seaborn', 'SALib==1.2', 'xlwt', 'jupyter', 'plotly', 'mock', 'pysal']
