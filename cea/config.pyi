...
class SystemCostsSection(Section):
    ...
    cooling_components: str
    heating_components: str
    heat_rejection_components: str
    ...
    @overload
    def __getattr__(self, item: Literal["cooling_components"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["heating_components"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["heat_rejection_components"]) -> str: ...
    def __getattr__(self, item: str) -> Any: ...
