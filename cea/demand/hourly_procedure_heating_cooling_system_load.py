...
def detailed_thermal_balance_to_tsd(tsd, bpr, t, rc_model_temperatures):
    ...
    tsd['Q_gain_sen_app'][t] = (rc_model_SIA.calc_phi_i_a(tsd['Ea'][t], tsd['Epro'][t], tsd['Qcpro_sys'][t]) - (tsd['Epro'][t] - tsd['Qcpro_sys'][t]))
    tsd['Q_gain_sen_pro'][t] = tsd['Epro'][t] - tsd['Qcpro_sys'][t]
