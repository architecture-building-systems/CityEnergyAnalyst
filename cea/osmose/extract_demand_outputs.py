...
def main():
    ...
    for name in building_names:
        ...
        output_df2['v_CO2_in_infil_occupant_m3pers'] = reduced_tsd_df['v_CO2_in_infil_occupant_m3pers']
...
def calc_m_infil(output_df):
    for i in range(output_df.shape[0]):
        t = 3217 + i
        if output_df['people'][t] == 0:
            output_df['m_ve_inf'][t] = output_df['people'][t]
...
def calc_CO2_gains(output_df, reduced_tsd_df):
    ...
    reduced_tsd_df['v_CO2_in_infil_occupant_m3pers'] = reduced_tsd_df['v_CO2_occupant_m3pers'] + reduced_tsd_df[
...
def calc_sensible_gains(output_df, reduced_tsd_df):
    ...
    # total
    reduced_tsd_df['Q_gain_total_kWh'] = reduced_tsd_df['Q_gain_rad_kWh'] + reduced_tsd_df['Q_gain_env_kWh'] + reduced_tsd_df[
