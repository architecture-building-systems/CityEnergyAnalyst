...
def calc_I_rad(t, tsd: dict, bpr: BuildingPropertiesRow):
    ...
    I_rad_win = tsd['RSE_win'][t] * bpr.rc_model.U_win * calc_hr(bpr.envelope.e_win, theta_ss) * bpr.rc_model.Awin_ag * delta_theta_er
    I_rad_roof = tsd['RSE_roof'][t] * bpr.rc_model.U_roof * calc_hr(bpr.envelope.e_roof, theta_ss) * bpr.rc_model.Aroof * delta_theta_er
    I_rad_wall = tsd['RSE_wall'][t] * bpr.rc_model.U_wall * calc_hr(bpr.envelope.e_wall, theta_ss) * bpr.rc_model.Awall_ag * delta_theta_er
    I_rad_underside = tsd['RSE_underside'][t] * bpr.rc_model.U_base * calc_hr(bpr.envelope.e_underside, theta_ss) * bpr.rc_model.Aunderside * delta_theta_er
