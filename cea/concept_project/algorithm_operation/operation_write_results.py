...
def main(locator,
    ...
    for building in m.buildings_names:
        ...
        outputs.to_csv(locator.get_mpc_results_outputs(building, output_folder, date_main))
        ...
        controls.to_csv(locator.get_mpc_results_controls(building, output_folder, date_main))
        ...
        states.to_csv(locator.get_mpc_results_states(building, output_folder, date_main))

        m.minimum_output_dic[building].to_csv(locator.get_mpc_results_min_outputs(building, output_folder, date_main))
        m.maximum_output_dic[building].to_csv(locator.get_mpc_results_max_outputs(building, output_folder, date_main))
    ...
    predicted_temperature_df.to_csv(locator.get_mpc_results_predicted_temperature(output_folder, date_main))
    set_temperature_df.to_csv(locator.get_mpc_results_set_temperature(output_folder, date_main))
    minimum_temperature_df.to_csv(locator.get_mpc_results_min_temperature(output_folder, date_main))
    maximum_temperature_df.to_csv(locator.get_mpc_results_max_temperature(output_folder, date_main))
    ...
    electric_power_df.to_csv(locator.get_mpc_results_electric_power(output_folder, date_main))
