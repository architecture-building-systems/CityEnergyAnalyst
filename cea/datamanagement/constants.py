...
OSM_BUILDING_CATEGORIES = {
    'residential': 'MULTI_RES', 'apartments': 'MULTI_RES', 'dormitory': 'MULTI_RES', 'terrace': 'MULTI_RES',
        'nursing_home': 'MULTI_RES', 'social_facility': 'MULTI_RES',
    ...
    'hotel': 'HOTEL',
    'office': 'OFFICE', 'civic': 'OFFICE', 'commercial': 'OFFICE', 'government': 'OFFICE', 'bureau_de_change': 'OFFICE',
        'courthouse': 'OFFICE', 'embassy': 'OFFICE', 'post_office': 'OFFICE', 'townhall': 'OFFICE',
    'industrial': 'INDUSTRIAL',
    'retail': 'RETAIL', 'kiosk': 'RETAIL', 'bank': 'RETAIL', 'pharmacy': 'RETAIL', 'marketplace': 'RETAIL',
    'supermarket': 'FOODSTORE',
    'restaurant': 'RESTAURANT', 'fast_food': 'RESTAURANT', 'food_court': 'RESTAURANT', 'bar': 'RESTAURANT',
        'biergarten': 'RESTAURANT', 'cafe': 'RESTAURANT', 'ice_cream': 'RESTAURANT', 'pub': 'RESTAURANT',
    'hospital': 'HOSPITAL', 'clinic': 'HOSPITAL', 'dentist': 'HOSPITAL', 'doctors': 'HOSPITAL',
        'veterinary': 'HOSPITAL',
    'school': 'SCHOOL', 'kindergarten': 'SCHOOL', 'childcare': 'SCHOOL', 'driving_school': 'SCHOOL',
        'language_school': 'SCHOOL', 'music_school': 'SCHOOL',
    'university': 'UNIVERSITY', 'college': 'UNIVERSITY',
    'library': 'LIBRARY', 'toy_library': 'LIBRARY',
    'gym': 'GYM', 'sports_hall': 'GYM', 'pavilion': 'GYM',
    'arts_centre': 'MUSEUM', 'cinema': 'MUSEUM', 'theatre': 'MUSEUM',
    'parking': 'PARKING', 'carport': 'PARKING', 'garage': 'PARKING', 'garages': 'PARKING', 'hangar': 'PARKING',
        'bicycle_parking': 'PARKING', 'charging_station': 'PARKING', 'motorcycle_parking': 'PARKING',
        'parking_entrance': 'PARKING', 'parking_space': 'PARKING', 'taxi': 'PARKING'}
