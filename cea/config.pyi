...
class Configuration:
    ...
    @overload
    def __getattr__(self, item: Literal["district_events_apply_changes"]) -> DistrictEventsApplyChangesSection: ...
    @overload
...
class DistrictAtomicChangesDefineSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["atomic_change_description"]) -> Any: ...
    @overload
...
class DistrictEventsApplyChangesSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["atomic_changes"]) -> List[str]: ...
    def __getattr__(self, item: str) -> Any: ...

class BakeStatesSection(Section):
    """Typed section for bake-states configuration"""
    existing_timeline_name: str
...
class AtomicChangeMultiChoiceParameter(Parameter): ...
