...
def calc_Qww_ls_st(ta, te, Tww_st, V, Qww, Qww_ls_r, Qww_ls_nr):
    """
    ...
    if V > 0:
        h = ( 4 * V * ASPECT_RATIO ** 2 / math.pi ) ** ( 1.0 / 3.0 )     # tank height in [m], derived from tank Aspect Ratio(AR)
...
def solve_ode_storage(Tww_st_0, ql, qd, qc, Vtank):
    """
