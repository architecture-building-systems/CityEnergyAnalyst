...
class DistrictEventsSection(Section):
    ...
    supply_heating_code: str | None
    supply_cooling_code: str | None
    supply_hotwater_code: str | None
    supply_electricity_code: str | None
    ...
    @overload
    def __getattr__(self, item: Literal["window_code"]) -> str | None: ...
    @overload
    def __getattr__(self, item: Literal["supply_heating_code"]) -> str | None: ...
    @overload
    def __getattr__(self, item: Literal["supply_cooling_code"]) -> str | None: ...
    @overload
    def __getattr__(self, item: Literal["supply_hotwater_code"]) -> str | None: ...
    @overload
    def __getattr__(self, item: Literal["supply_electricity_code"]) -> str | None: ...
    def __getattr__(self, item: str) -> Any: ...
