...
.. graphviz::
    ...
    "district.shp" -> "sewage-potential"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "data-helper"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "network-layout"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "operation-costs"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "solar-collector"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "lake-potential"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "thermal-network"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "photovoltaic-thermal"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "emissions"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "demand"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "radiation"[label="(get_surrounding_geometry)"]
...
.. graphviz::
    ...
    "district.shp" -> "photovoltaic"[label="(get_surrounding_geometry)"]
