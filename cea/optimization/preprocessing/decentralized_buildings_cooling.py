    ...
    for building_name in building_names:
        ...
        if config.decentralized.AHUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU[1][7] += lca.prices.ELEC_PRICE * VCC_to_AHU_operation['wdot_W']  # CHF
                ...
                # 2: single-effect ACH
                single_effect_ACH_to_AHU_operation = chiller_absorption.calc_chiller_main(mdot_AHU_kgpers[hour],
                                                                                          T_sup_AHU_K[hour],
                                                                                          T_re_AHU_K[hour],
                                                                                          T_hw_in_FP_C[hour],
                                                                                          T_ground_K[hour],
                ...
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_AHU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                q_boiler_single_ACH_to_AHU_W[hour] = single_effect_ACH_to_AHU_operation['q_hw_W'] - q_sc_gen_FP_Wh[
                    hour] if (
                ...
                # 3: double-effect ACH
                double_effect_ACH_to_AHU_operation = chiller_absorption.calc_chiller_main(mdot_AHU_kgpers[hour],
                                                                                          T_sup_AHU_K[hour],
                                                                                          T_re_AHU_K[hour],
                                                                                          T_hw_in_ET_C[hour],
                                                                                          T_ground_K[hour],
                                                                                          ...
                                                                                          Qnom_ACH_W, locator, config)
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_AHU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
                ...
                q_burner_double_ACH_to_AHU_W[hour] = double_effect_ACH_to_AHU_operation['q_hw_W'] - q_sc_gen_ET_Wh[
                    hour] if (
        ...
        if config.decentralized.ARUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                VCC_to_ARU_operation = chiller_vapor_compression.calc_VCC(mdot_ARU_kgpers[hour], T_sup_ARU_K[hour],
                                                                          ...
                                                                          number_of_VCC_chillers)
                result_ARU[1][7] += lca.prices.ELEC_PRICE * VCC_to_ARU_operation['wdot_W']  # CHF
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_ARU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_ARU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
        ...
        if config.decentralized.SCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                VCC_to_SCU_operation = chiller_vapor_compression.calc_VCC(mdot_SCU_kgpers[hour], T_sup_SCU_K[hour],
                                                                          ...
                                                                          number_of_VCC_chillers)
                result_SCU[1][7] += lca.prices.ELEC_PRICE * VCC_to_SCU_operation['wdot_W']  # CHF
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_SCU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_SCU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
        ...
        if config.decentralized.AHUARUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                VCC_to_AHU_ARU_operation = chiller_vapor_compression.calc_VCC(mdot_AHU_ARU_kgpers[hour],
                                                                              ...
                                                                              number_of_VCC_chillers)
                result_AHU_ARU[1][7] += lca.prices.ELEC_PRICE * VCC_to_AHU_ARU_operation['wdot_W']  # CHF
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_AHU_ARU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                q_boiler_single_ACH_to_AHU_ARU_W[hour] = single_effect_ACH_to_AHU_ARU_operation['q_hw_W'] - \
                                                         q_sc_gen_FP_Wh[
                                                             hour] if (
                        q_sc_gen_FP_Wh[hour] >= 0) else single_effect_ACH_to_AHU_ARU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_single_ACH_to_AHU_ARU_K[hour] = single_effect_ACH_to_AHU_ARU_operation[
                                                                'T_hw_out_C'] + 273.15
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_AHU_ARU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
                ...
                q_burner_double_ACH_to_AHU_ARU_W[hour] = double_effect_ACH_to_AHU_ARU_operation['q_hw_W'] - \
                                                         q_sc_gen_ET_Wh[
                                                             hour] if (
                        q_sc_gen_ET_Wh[hour] >= 0) else double_effect_ACH_to_AHU_ARU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_double_ACH_to_AHU_ARU_K[hour] = double_effect_ACH_to_AHU_ARU_operation[
                                                                'T_hw_out_C'] + 273.15
        ...
        if config.decentralized.AHUSCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                VCC_to_AHU_SCU_operation = chiller_vapor_compression.calc_VCC(mdot_AHU_SCU_kgpers[hour],
                                                                              ...
                                                                              number_of_VCC_chillers)
                result_AHU_SCU[1][7] += lca.prices.ELEC_PRICE * VCC_to_AHU_SCU_operation['wdot_W']  # CHF
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_AHU_SCU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                q_boiler_single_ACH_to_AHU_SCU_W[hour] = single_effect_ACH_to_AHU_SCU_operation['q_hw_W'] - \
                                                         q_sc_gen_FP_Wh[
                                                             hour] if (
                        q_sc_gen_FP_Wh[hour] >= 0) else single_effect_ACH_to_AHU_SCU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_single_ACH_to_AHU_SCU_K[hour] = single_effect_ACH_to_AHU_SCU_operation[
                                                                'T_hw_out_C'] + 273.15
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_AHU_SCU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
                ...
                q_burner_double_ACH_to_AHU_SCU_W[hour] = double_effect_ACH_to_AHU_SCU_operation['q_hw_W'] - \
                                                         q_sc_gen_ET_Wh[
                                                             hour] if (
                        q_sc_gen_ET_Wh[hour] >= 0) else double_effect_ACH_to_AHU_SCU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_double_ACH_to_AHU_SCU_K[hour] = double_effect_ACH_to_AHU_SCU_operation[
                                                                'T_hw_out_C'] + 273.15
        ...
        if config.decentralized.ARUSCUflag:
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                VCC_to_ARU_SCU_operation = chiller_vapor_compression.calc_VCC(mdot_ARU_SCU_kgpers[hour],
                                                                              ...
                                                                              number_of_VCC_chillers)
                result_ARU_SCU[1][7] += lca.prices.ELEC_PRICE * VCC_to_ARU_SCU_operation['wdot_W']  # CHF
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_ARU_SCU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                q_boiler_single_ACH_to_ARU_SCU_W[hour] = single_effect_ACH_to_ARU_SCU_operation['q_hw_W'] - \
                                                         q_sc_gen_FP_Wh[
                                                             hour] if (
                        q_sc_gen_FP_Wh[hour] >= 0) else single_effect_ACH_to_ARU_SCU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_single_ACH_to_ARU_SCU_K[hour] = single_effect_ACH_to_ARU_SCU_operation[
                                                                'T_hw_out_C'] + 273.15
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_ARU_SCU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
                ...
                q_burner_double_ACH_to_ARU_SCU_W[hour] = double_effect_ACH_to_ARU_SCU_operation['q_hw_W'] - \
                                                         q_sc_gen_ET_Wh[
                                                             hour] if (
                        q_sc_gen_ET_Wh[hour] >= 0) else double_effect_ACH_to_ARU_SCU_operation['q_hw_W']
                # TODO: this is assuming the mdot in SC is higher than hot water in the generator
                T_re_boiler_double_ACH_to_ARU_SCU_K[hour] = double_effect_ACH_to_ARU_SCU_operation[
                                                                'T_hw_out_C'] + 273.15
        ...
        if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
            ...
            for hour in range(8760):  # TODO: vectorize
                ...
                result_AHU_ARU_SCU[1][7] += lca.prices.ELEC_PRICE * VCC_to_AHU_ARU_SCU_operation['wdot_W']  # CHF
                ...
                single_effect_ACH_to_AHU_ARU_SCU_operation = chiller_absorption.calc_chiller_main(
                ...
                # add costs from electricity consumption
                el_for_FP_ACH_W = single_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_FP_Wh[hour]
                result_AHU_ARU_SCU[2][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                double_effect_ACH_to_AHU_ARU_SCU_operation = chiller_absorption.calc_chiller_main(
                    mdot_AHU_ARU_SCU_kgpers[hour],
                    T_sup_AHU_ARU_SCU_K[hour],
                    T_re_AHU_ARU_SCU_K[hour],
                    T_hw_in_ET_C[hour],
                ...
                # add costs from electricity consumption
                el_for_ET_ACH_W = double_effect_ACH_to_AHU_operation['wdot_W'] + w_SC_ET_Wh[hour]
                result_AHU_ARU_SCU[3][7] += lca.prices.ELEC_PRICE * el_for_ET_ACH_W  # CHF
                ...
                result_AHU_ARU_SCU[4][7] += lca.prices.ELEC_PRICE * (
                ...
                el_for_FP_ACH_W = VCC_to_AHU_ARU_operation['wdot_W'] + single_effect_ACH_to_SCU_operation['wdot_W'] + \
                                  w_SC_FP_Wh[hour]
                result_AHU_ARU_SCU[5][7] += lca.prices.ELEC_PRICE * el_for_FP_ACH_W  # CHF
                ...
                q_CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W[hour] = (
                            VCC_to_AHU_ARU_operation['q_cw_W'] + single_effect_ACH_to_SCU_operation['q_cw_W'])
        ...
        CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_nom_size_W = np.max(q_CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W) * (
                    1 + SIZING_MARGIN)
        ...
        for hour in range(8760):
            ...
            if config.decentralized.AHUflag:
                ...
                result_AHU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_AHU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if config.decentralized.ARUflag:
                ...
                result_ARU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_ARU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if config.decentralized.SCUflag:
                ...
                result_SCU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_SCU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if config.decentralized.AHUARUflag:
                ...
                result_AHU_ARU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_AHU_ARU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if config.decentralized.AHUSCUflag:
                ...
                result_AHU_SCU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_AHU_SCU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if config.decentralized.ARUSCUflag:
                ...
                result_ARU_SCU[2][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                result_ARU_SCU[3][7] += lca.ELEC_PRICE * wdot_W  # CHF
            ...
            if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
                ...
                result_AHU_ARU_SCU[1][7] += lca.ELEC_PRICE * wdot_W  # CHF
                ...
                wdot_W = cooling_tower.calc_CT(q_CT_single_ACH_to_AHU_ARU_SCU_W[hour],
                                               CT_single_ACH_to_AHU_ARU_SCU_nom_size_W)
                result_AHU_ARU_SCU[2][7] += lca.prices.ELEC_PRICE * wdot_W  # CHF
                ...
                wdot_W = cooling_tower.calc_CT(q_CT_double_ACH_to_AHU_ARU_SCU_W[hour],
                                               CT_double_ACH_to_AHU_ARU_SCU_nom_size_W)
                result_AHU_ARU_SCU[3][7] += lca.prices.ELEC_PRICE * wdot_W  # CHF
                ...
                result_AHU_ARU_SCU[4][7] += lca.prices.ELEC_PRICE * wdot_W  # CHF
                ...
                wdot_W = cooling_tower.calc_CT(q_CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W[hour],
                                               CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_nom_size_W)
                result_AHU_ARU_SCU[5][7] += lca.prices.ELEC_PRICE * wdot_W  # CHF
            ...
            # AHU
            if config.decentralized.AHUflag:
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_AHU_W[hour],
                                                    boiler_single_ACH_to_AHU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_AHU_K[hour]) if \
                q_boiler_single_ACH_to_AHU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_AHU_W[hour],
                                                    burner_double_ACH_to_AHU_nom_size_W) if \
                q_burner_double_ACH_to_AHU_W[hour] > 0 else 0
            ...
            # ARU
            if config.decentralized.ARUflag:
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_ARU_W[hour],
                                                    boiler_single_ACH_to_ARU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_ARU_K[hour]) if \
                q_boiler_single_ACH_to_ARU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_ARU_W[hour],
                                                    burner_double_ACH_to_ARU_nom_size_W) if \
                q_burner_double_ACH_to_ARU_W[
                    hour] > 0 else 0
            ...
            # SCU
            if config.decentralized.SCUflag:
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_SCU_W[hour],
                                                    boiler_single_ACH_to_SCU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_SCU_K[hour]) if \
                                                    q_boiler_single_ACH_to_SCU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_SCU_W[hour],
                                                    burner_double_ACH_to_SCU_nom_size_W) if \
                q_burner_double_ACH_to_SCU_W[
                    hour] > 0 else 0
            ...
            # AHU + ARU
            if config.decentralized.AHUARUflag:
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_AHU_ARU_W[hour],
                                                    boiler_single_ACH_to_AHU_ARU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_AHU_ARU_K[hour]) if \
                                                    q_boiler_single_ACH_to_AHU_ARU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_AHU_ARU_W[hour],
                                                    burner_double_ACH_to_AHU_ARU_nom_size_W) if \
                q_burner_double_ACH_to_AHU_ARU_W[
                    hour] > 0 else 0
            ...
            # AHU + SCU
            if config.decentralized.AHUSCUflag:
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_AHU_SCU_W[hour],
                                                    boiler_single_ACH_to_AHU_SCU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_AHU_SCU_K[hour]) if \
                                                    q_boiler_single_ACH_to_AHU_SCU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_AHU_SCU_W[hour],
                                                    burner_double_ACH_to_AHU_SCU_nom_size_W) if \
                                                    q_burner_double_ACH_to_AHU_SCU_W[hour] > 0 else 0
            ...
            if config.disconnected_cooling.ARUSCUflag:
                ...
                q_boiler_single_ACH_to_ARU_SCU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_ARU_SCU_W[hour],
                                                    burner_double_ACH_to_ARU_SCU_nom_size_W) if \
                q_burner_double_ACH_to_ARU_SCU_W[
                    hour] > 0 else 0
            ...
            if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
                ...
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_single_ACH_to_AHU_ARU_SCU_W[hour],
                                                    boiler_single_ACH_to_AHU_ARU_SCU_nom_size_W,
                                                    T_re_boiler_single_ACH_to_AHU_ARU_SCU_K[hour]) if \
                                                    q_boiler_single_ACH_to_AHU_ARU_SCU_W[hour] > 0 else 0
                ...
                burner_eff = burner.calc_cop_burner(q_burner_double_ACH_to_AHU_ARU_SCU_W[hour],
                                                    burner_double_ACH_to_AHU_ARU_SCU_nom_size_W) if \
                q_burner_double_ACH_to_AHU_ARU_SCU_W[
                    hour] > 0 else 0
                ...
                boiler_eff = boiler.calc_Cop_boiler(q_boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W[hour],
                                                    boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_nom_size_W,
                                                    T_re_boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_K[hour]) if \
                q_boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W[
                    hour] > 0 else 0
                Q_gas_for_boiler_Wh = q_boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_W[
        ...
        if config.decentralized.AHUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_AHU_W, locator, config,
                                                                            'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_AHU_nom_size_W, locator, config, 'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_AHU_nom_size_W, locator, config,
                                                                  'BO1')
            Inv_Costs_AHU[2][0] = Capex_a_CT + Opex_CT + \
                                  Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_AHU_nom_size_W, locator, config, 'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_AHU_nom_size_W, locator, config,
                                                                  'BO1')
        ...
        if config.decentralized.ARUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_ARU_W, locator, config,
                                                                            'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_ARU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_ARU_nom_size_W, locator, config, 'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_ARU_nom_size_W, locator, config,
                                                                  'BO1')
            Inv_Costs_ARU[2][0] = Capex_a_CT + Opex_CT + \
                                  Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_ARU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_ARU_nom_size_W, locator, config, 'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_ARU_nom_size_W, locator, config,
                                                                  'BO1')
        ...
        if config.decentralized.SCUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_SCU_W, locator, config,
                                                                            'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_SCU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_SCU_nom_size_W, locator, config, 'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_SCU_nom_size_W, locator, config,
                                                                  'BO1')
            Inv_Costs_SCU[2][0] = Capex_a_CT + Opex_CT + \
                                  Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_SCU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_SCU_nom_size_W, locator, config, 'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_SCU_nom_size_W, locator, config,
                                                                  'BO1')
        ...
        if config.decentralized.AHUARUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_AHU_ARU_W, locator,
                                                                            config, 'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_ARU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_AHU_ARU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_AHU_ARU_nom_size_W, locator,
                                                                  config, 'BO1')
            Inv_Costs_AHU_ARU[2][0] = Capex_a_CT + Opex_CT + \
                                      Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_ARU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_AHU_ARU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_AHU_ARU_nom_size_W, locator,
                                                                  config, 'BO1')
        ...
        if config.decentralized.AHUSCUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_AHU_SCU_W, locator,
                                                                            config, 'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_SCU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_AHU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_AHU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
            Inv_Costs_AHU_SCU[2][0] = Capex_a_CT + Opex_CT + \
                                      Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_SCU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_AHU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_AHU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
        ...
        if config.decentralized.ARUSCUflag:
            ...
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_ARU_SCU_W, locator,
                                                                            config, 'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_ARU_SCU_W, locator, ACH_type_single,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_ARU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_ARU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
            Inv_Costs_ARU_SCU[2][0] = Capex_a_CT + Opex_CT + \
                                      Capex_a_ACH + Opex_ACH + Capex_a_boiler + Opex_boiler + Capex_a_SC_FP + Opex_SC_FP

            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_ARU_SCU_W, locator, ACH_type_double,
                                                                 config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_ARU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_ARU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
        ...
        if True:  # for the case with AHU + ARU + SCU scenario. this should always be present
            ...
            # VCC + CT
            Capex_a_VCC, Opex_VCC = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_AHU_ARU_SCU_W, locator,
                                                                            config, 'CH3')
            ...
            Capex_a_ACH, Opex_ACH = chiller_absorption.calc_Cinv(Qc_nom_combination_AHU_ARU_SCU_W, locator,
                                                                 ACH_type_single, config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_single_ACH_to_AHU_ARU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(boiler_single_ACH_to_AHU_ARU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
            ...
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_double_ACH_to_AHU_ARU_SCU_nom_size_W, locator, config,
                                                             'CT1')
            Capex_a_burner, Opex_burner = burner.calc_Cinv_burner(burner_double_ACH_to_ARU_SCU_nom_size_W, locator,
                                                                  config, 'BO1')
            ...
            Capex_a_VCC_AA, Opex_VCC_AA = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_AHU_ARU_W, locator,
                                                                                  config, 'CH3')
            Capex_a_VCC_S, Opex_VCC_S = chiller_vapor_compression.calc_Cinv_VCC(Qc_nom_combination_SCU_W, locator,
                                                                                config, 'CH3')
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_VCC_to_AHU_ARU_and_VCC_to_SCU_nom_size_W, locator,
                                                             config, 'CT1')
            Inv_Costs_AHU_ARU_SCU[4][
                0] = Capex_a_CT + Opex_CT + Capex_a_VCC_AA + Capex_a_VCC_S + Opex_VCC_AA + Opex_VCC_S

            # VCC (AHU + ARU) + ACH (SCU) + CT + Boiler + SC_FP
            Capex_a_ACH_S, Opex_ACH_S = chiller_absorption.calc_Cinv(Qc_nom_combination_SCU_W, locator, ACH_type_single,
                                                                     config)
            Capex_a_CT, Opex_CT = cooling_tower.calc_Cinv_CT(CT_VCC_to_AHU_ARU_and_single_ACH_to_SCU_nom_size_W,
                                                             locator, config, 'CT1')
            Capex_a_boiler, Opex_boiler = boiler.calc_Cinv_boiler(
                boiler_VCC_to_AHU_ARU_and_single_ACH_to_SCU_nom_size_W, locator, config, 'BO1')
            Capex_a_SC_FP, Opex_SC_FP = solar_collector.calc_Cinv_SC(SC_FP_data['Area_SC_m2'][0], locator, config,
                                                                     technology=0)
        ...
        dico["Nominal Power single effect ACH to AHU_ARU_SCU"] = result_AHU_ARU_SCU[:,
                                                                 2] * Qc_nom_combination_AHU_ARU_SCU_W
        dico["Nominal Power double effect ACH to AHU_ARU_SCU"] = result_AHU_ARU_SCU[:,
