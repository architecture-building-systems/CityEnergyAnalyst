...
def dhw_hex_operation(Q_dhw, hex_type, A_hex_dhw_design, T_amb, mdot_dhw_design, U):
    ...
    if hex_type == "LT":
        T_s1 = 55 + 273
        T_s2 = 50 + 273 # Target temp of hot water @ LT design = 45 °C
...
def interface_hex_design(Q_finalheat_design, T_return_min_global, T_supply_max_global, hex_type, U):
    ...
    if hex_type == "LT":
        T_s2 = 50 + 5 + 273 # lower temp of hot water @ LT design 
...
def design_inhouse_exchangers(Q_heating_design, Q_dhw_design, Q_finalheat_design, T_amb_max, T_return_min_global, T_supply_max_global, hex_type, U):
    ...
    A_hex_heating_design, mdot_heating_design = heating_hex_design(Q_heating_design, T_return_min_global, T_supply_max_global, hex_type, cp)
    A_hex_dhw_design, mdot_dhw_design, k_dhw_des = dhw_hex_design(Q_dhw_design, mdot_internal_dhw_design, hex_type, U, cp)
