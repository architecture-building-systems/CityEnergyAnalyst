...
VCC_T_COOL_IN = 30 + KELVIN_OFFSET  # entering condenser water temperature [K]
VCC_MIN_LOAD = 0.1  # min load for cooling power
VCC_CODE_CENTRALIZED = 'CH1'
VCC_CODE_DECENTRALIZED = 'CH2'

# Absorption chiller
ACH_T_IN_FROM_CHP_K = 150.0 + KELVIN_OFFSET  # hot water from CHP to the generator of ACH
...
T_TANK_FULLY_CHARGED_K = 4 + KELVIN_OFFSET
T_TANK_FULLY_DISCHARGED_K = 14 + KELVIN_OFFSET
...
T_FROM_SERVER = 60 + KELVIN_OFFSET  # K
T_TO_SERVER = 55 + KELVIN_OFFSET  # K
