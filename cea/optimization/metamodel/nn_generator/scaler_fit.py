...
def range_collector(locator,counter):
    ...
    :return:
    '''
    nn_inout_path = locator.get_optimization_nn_inout_folder()
    i=counter
    scaler_inout_path = locator.get_optimization_minmaxscaler_folder()
...
def range_finder(locator, number_samples_scaler):
    ...
    scalerX_file, scalerT_file = locator.get_optimization_minmaxscalar_model()
