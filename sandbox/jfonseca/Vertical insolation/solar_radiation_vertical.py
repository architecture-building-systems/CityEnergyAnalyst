...
def test_solar_radiation():
    ...
    path_boundary = os.path.join(r'C:\reference-case', 'baseline', '1-inputs', '1-buildings', 'zone_of_study.shp')
    path_geometry = os.path.join(r'C:\reference-case', 'baseline', '1-inputs', '1-buildings', 'building_geometry.shp')
    path_terrain = os.path.join(r'C:\reference-case', 'baseline', '1-inputs', '2-terrain', 'terrain')
    weather_daily_data = os.path.join(r'C:\reference-case', 'baseline', '1-inputs', '3-weather', 'weather_day.csv')
    path_output = os.path.join(r'C:\reference-case','baseline', '2-resultst', '1-radiation', '1-timeseries', 'radiation.csv')
