...
def lca_embodied(yearcalc, locator, gv):
    ...
    fields_to_plot = ['Name', 'GFA_m2', 'E_pen_GJ', 'E_pen_MJm2', 'E_ghg_ton', 'E_ghg_kgm2']
    pd.DataFrame({'Name': result[0].Name, 'E_pen_GJ': result[0].GEN_GJ, 'E_pen_MJm2': result[0].GEN_MJm2,
