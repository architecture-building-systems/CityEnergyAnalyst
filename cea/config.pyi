...
class Configuration:
    ...
    system_costs_solar: SystemCostsSolarSection
    ...
    @overload
    def __getattr__(self, item: Literal["system_costs_solar"]) -> SystemCostsSolarSection: ...
    @overload
...
class SystemCostsSolarSection(Section):
    """Typed section for system-costs-solar configuration"""
    buildings: list[str]
    panels_on_roof: str
    ...
    @overload
    def __getattr__(self, item: Literal["panels_on_wall_north"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["panels_on_wall_south"]) -> str: ...
    @overload
    def __getattr__(self, item: Literal["panels_on_wall_east"]) -> str: ...
    @overload
...
class DCNetworkLayoutChoiceParameter(Parameter): ...
class DHNetworkLayoutChoiceParameter(Parameter): ...
