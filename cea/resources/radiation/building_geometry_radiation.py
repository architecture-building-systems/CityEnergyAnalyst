...
class BuildingGeometryForRadiation(object):
    ...
    def group(self, srf_type: str) -> SurfaceGroup:
        mapping_dict = {
            'walls': (self.walls, self.orientation_walls, self.normals_walls, self.intersect_walls),
            'windows': (self.windows, self.orientation_windows, self.normals_windows, self.intersect_windows),
            'roofs': (self.roofs, self.orientation_roofs, self.normals_roofs, self.intersect_roofs),
            'undersides': (self.undersides, self.orientation_undersides, self.normals_undersides, self.intersect_undersides),
        }
