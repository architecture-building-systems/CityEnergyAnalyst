...
def calc_operating_conditions(absorption_chiller, input_conditions):
    ...
    T_cw_in_C = input_conditions['T_ground_K'] - KELVIN_CONVERSION  # condenser water inlet temperature
    T_chw_in_C = input_conditions['T_chw_re_K'] - KELVIN_CONVERSION  # inlet to the evaporator
    T_chw_out_C = input_conditions['T_chw_sup_K'] - KELVIN_CONVERSION  # outlet from the evaporator
