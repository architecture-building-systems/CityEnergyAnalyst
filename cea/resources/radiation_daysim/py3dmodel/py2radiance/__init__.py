...
class Rad(object):
    ...
    def create_sensor_input_file(self,points_file_name):
        sensor_file_path = os.path.join(self.data_folder_path, points_file_name)
    ...
    def execute_cumulative_rtrace(self, ab, pointsfilename):
        ...
        command = "rtrace -af ambientfile -n 8 -I -h -dp 2048 -ms 0.063 -ds .2 -dt .05 -dc .75 -dr 3 -st .01 -lr 12 -lw .0005 -ab " + ab + " -ad 1000 -as 20 -ar 300 -aa 0.1   "+\
...
#==========================================================================================================================
    ...
    def write_radiance_parameters(self,rad_n,rad_af,rad_ab,rad_ad,rad_as,rad_ar,rad_aa,rad_lr,rad_st,rad_sj,rad_lw,rad_dj,rad_ds,rad_dr,rad_dp):
    ...
    def write_default_radiance_parameters(self):
        ...
        rad_dr = 2
        rad_dp = 512
        self.write_radiance_parameters(rad_n,rad_af,rad_ab,rad_ad,rad_as,rad_ar,rad_aa,rad_lr,
                                       rad_st,rad_sj,rad_lw,rad_dj,rad_ds,rad_dr,rad_dp)
        
    def execute_gen_dc(self, output_unit,i):
        hea_filepath = self.hea_file
        hea_file = open(hea_filepath,  "a")
        ...
        points_file_name="sensor_points"+i+".pts"
        #hea_file.write("\nsensor_file" + " " + os.path.join("pts", tail))
        hea_file.write("\nsensor_file" + " " + os.path.join("pts", points_file_name))
        ...
        temp_hea_filepath = os.path.join(self.daysimdir_tmp, tail+"temp"+i+".hea")
