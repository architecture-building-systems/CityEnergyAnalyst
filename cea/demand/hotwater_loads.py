...
from cea.constants import HEAT_CAPACITY_OF_WATER_JPERKGK, P_WATER_KGPERM3, HOURS_IN_YEAR, KELVIN_CONVERSION
...
# final hot water demand calculation
# NOTE: calc_Qwwf() function removed - primary energy calculation for DHW moved to primary-energy module
