...
def calculate_mixed_use_archetype_values_results(locator):
    ...
    occ_densities = pd.read_csv(locator.get_db4_archetypes_schedules_use_type_csv()).set_index('code')
    ...
    calculated_results = calculate_average_multiuse(
        ...
        properties_DB=pd.read_csv(locator.get_db4_archetypes_schedules_use_type_csv())).set_index('code')
