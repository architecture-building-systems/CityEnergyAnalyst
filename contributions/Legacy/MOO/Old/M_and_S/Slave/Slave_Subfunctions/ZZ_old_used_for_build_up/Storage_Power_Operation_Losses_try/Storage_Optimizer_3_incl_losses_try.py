...
import SolarPowerHandler_V6 as SPH_fn
...
Q_stored_max, Q_rejected_fin, Q_disc_seasonstart, T_st_max, T_st_min, Q_storage_content_fin, T_storage_fin, Q_loss0 = StDesOp.Storage_Design(CSV_NAME, SOLCOL_TYPE, T_storage_old, Q_in_storage_old, Network_Data_Path, V_storage_initial)


if T_st_max <= T_ST_MAX or T_st_min >= T_ST_MIN: # STart optimizing
    # first Round optimization
    V_storage_possible_needed = (Q_stored_max + Q_loss0) * gV.Wh_to_J / (gV.rho_60 * gV.cp * (T_ST_MAX - T_ST_MIN))
    Q_initial = Q_stored_max / 2.0 + Q_loss0
    ...
    Q_stored_max_opt, Q_rejected_fin_opt,Q_disc_seasonstart_opt, T_st_max_op, T_st_min_op, Q_storage_content_fin_op, T_storage_fin_op, Q_loss1 = Optimized_Data
    ...
    Q_stored_max_opt2, Q_rejected_fin_opt2,Q_disc_seasonstart_opt2, T_st_max_op2, T_st_min_op2, Q_storage_content_fin_op2, T_storage_fin_op2, Q_loss2 = Optimized_Data2
    ...
    Q_stored_max_opt3, Q_rejected_fin_opt3,Q_disc_seasonstart_opt3, T_st_max_op3, T_st_min_op3, Q_storage_content_fin_op3, T_storage_fin_op3, Q_loss3 = Optimized_Data3
    ...
    Q_stored_max_opt4, Q_rejected_fin_opt4,Q_disc_seasonstart_opt4, T_st_max_op4, T_st_min_op4, Q_storage_content_fin_op4, T_storage_fin_op4, Q_loss4 = Optimized_Data4
    ...
    Q_stored_max_opt5, Q_rejected_fin_opt5,Q_disc_seasonstart_opt5, T_st_max_op5, T_st_min_op5, Q_storage_content_fin_op5, T_storage_fin_op5, Q_loss5 = Optimized_Data5
